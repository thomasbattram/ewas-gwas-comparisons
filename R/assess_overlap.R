...
write.table(fin_auc_dat, "report/report_data/auc_data.txt", row.names = F, col.names = T, quote = F, sep = "\t")
...
ggsave("results/plots/all_traits_overlap_bar.pdf", plot = bar_p)
ggsave("report/report_data/figure_dat/all_traits_overlap_bar.pdf", plot = bar_p)

# ggsave("test.pdf", bar_p)