...
files <- c("data/glucose_ewas/insulin_ewas_data.RData", "data/glucose_ewas/glucose_ewas_data.RData") # Add R data files 
names(files) <- c("insulin", "glucose") # give them names corresponding to the traits
...
## Removing prevalent CKD EWAS (corresponding GWAS is eGFR)
