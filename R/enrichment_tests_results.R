...
# only 20 out of 3588 pathways are regularly present in over half of 
...
save(gene_overlap_tabs, file = "report/report_data/gene_overlap_results.RData")
save(pathway_overlap_tabs, file = "report/report_data/pathway_overlap_results.RData")
save(pathway_enrich_tabs, file = "report/report_data/pathway_enrichment_results.RData")
