...
library(FDb.InfiniumMethylation.hg19) # annotations
library(IlluminaHumanMethylation450kanno.ilmn12.hg19) # annotations
library(usefunc) # own package of useful functions

args <- commandArgs(trailingOnly = TRUE)
# args <- c("2", "1", "genes", "go", "~/projects/epi_gen_comp")
...
params2 <- expand.grid(
	n_genes = c(1000, 5000),
	gwas_power = c(0.05, 0.1, 0.2, 0.5, 1),
	ewas_power = c(0.1),
...
path <- "data/derived/sim_temp_gwas_power/"
